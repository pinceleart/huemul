  ...
  #robot.hear /hola/i, (msg) -> #test local
    ...
    if msg.message.room == anuncios.id
      robot.send {room: msg.message.user.id}, "¡Hola, *#{msg.message.user.name}*! :wave: \n
        ...
        Te sugerimos presentarte en <#C0R6E19QS|random> y te daremos la bienvenida como corresponde. Para conocer mis comandos puedes enviarme un `help` por MD o decir `huemul help` en algún canal y te mostraré lo que puedo hacer.\n
